...
beets_config = beets_ns.model('BeetsConfig', {
...
notification_service = notifications_ns.model('NotificationService', {
    'id': fields.String(
...
notification_test_result = notifications_ns.model('NotificationTestResult', {
...
notification_settings = notifications_ns.model('NotificationSettings', {
    'title': fields.String(
...
api_key = clients_ns.model('ClientAPIKey', {
...
auth_token = authentication_ns.model('AuthToken', {
    'token': fields.String(
